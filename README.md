...
3. If you are downloading a course with a lot of media files, make sure you have the option `Ask where to save each file before downloading` in [chrome settings disabled](https://td.wku.edu/TDClient/34/Portal/KB/ArticleDet?ID=3395)
