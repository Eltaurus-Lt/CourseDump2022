...
3. If you are downloading a course with a lot of media files, make sure you have the option `Ask where to save each file before downloading` in chrome settings (chrome://settings/downloads) disabled
